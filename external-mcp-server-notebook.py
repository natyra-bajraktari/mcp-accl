...
# MAGIC
# MAGIC
# MAGIC <img src="https://github.com/natyra-bajraktari/mcp-accl/blob/main/img/conn1.png?raw=true" style="width: 800px; margin-left: 10px">
# MAGIC
# MAGIC
# MAGIC 3. Provide the external MCP server endpoint (e.g., Bright Data MCP endpoint).
# MAGIC
# MAGIC
# MAGIC <img src="https://github.com/natyra-bajraktari/mcp-accl/blob/main/img/conn2.png?raw=true" style="width: 800px; margin-left: 10px">
# MAGIC
# MAGIC
# MAGIC 4. Mark the checkbox **"Is MCP connection"** to indicate this is an MCP server.
# MAGIC
# MAGIC
# MAGIC <img src="https://github.com/natyra-bajraktari/mcp-accl/blob/main/img/conn3.png?raw=true" style="width: 800px; margin-left: 10px">
# MAGIC
# MAGIC
...
# MAGIC
# MAGIC <img src="https://github.com/natyra-bajraktari/mcp-accl/blob/main/img/add_tool.png?raw=true" style="width: 800px; margin-left: 10px">
...
# MAGIC
# MAGIC <img src="https://github.com/natyra-bajraktari/mcp-accl/blob/main/img/play.png?raw=true" style="width: 800px; margin-left: 10px">
# MAGIC
# MAGIC
